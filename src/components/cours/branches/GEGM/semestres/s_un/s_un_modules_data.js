...
const GEGM_S_UN_MODULES_DATA = [
	{
		id: 1,
		moduleName: "GEGM Module 1",
		providedLink: "sisttara.com",
		playList: {
			id: 1,
			owner: "Sisttara",
			description: "GEGM module description",
			videos: GEGM_S_UN_MODULE_UN_VIDEOS,
		},
	},
	{
		id: 2,
		moduleName: "GEGM Module 2",
		providedLink: "sisttara.com",
		playList: {
			id: 1,
			owner: "Sisttara",
			description: "GEGM module 2 description",
			videos: GEGM_S_UN_MODULE_DEUX_VIDEOS,
		},
	},
	{
		id: 3,
		moduleName: "GEGM Module 3",
		providedLink: "sisttara.com",
		playList: {
			id: 1,
			owner: "Sisttara",
